...
There are **4 tasks** and **2 checkpoints** in this lab, and you will need to submit (push) your results and demonstrate them to a lab TA before **11:59PM February 13, 2024**.
...
where we want to find a desired control sequences $u_{0:T} := (u_0, ..., u_T)$ that leads to a trajectory $x_{0:T} := (x_0, ..., x_T)$, minimizes the cost $J$ over next $H$ steps.
