...
class Config():
    def __init__(self):
        ...
        # reference velocity
        self.v_ref = 2.0 # reference velocity
        ####################################################
        ...
        self.vel_limit_a = 0.1 # parameter for speed limit cost
        self.vel_limit_b = 100.0 # parameter for ExpLinear Cost
        ...
        # Lane Boundary Cost
        self.dim_right_boundary = 10 # dimension of lane boundary in the reference
        self.dim_left_boundary = 10 # dimension of lane boundary in the reference
        self.lane_boundary_a = 100.0 # parameter for lane boundary cost
        self.lane_boundary_b = 20.0 # parameter for ExpLinear Cost
        ...
        ########        Obstacle Cost          ############
        self.obs_a = 1000.0 # parameter for obstacle cost
        self.obs_b = 1000.0 # parameter for ExpLinear Cost
