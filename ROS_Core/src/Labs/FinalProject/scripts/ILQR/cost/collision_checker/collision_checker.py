...
class CollisionChecker:
    ...
    def _check_collision(self, state: np.ndarray, polytope: hppfcl.ConvexBase) -> np.ndarray:
        ...
        if np.any(np.isnan(output)):
            ...
            #     print("NAN in collision, ego_x")
            # if np.isnan(output[1]):
            #     print("NAN in collision, ego_y")
            # if np.isnan(output[2]):
            #     print("NAN in collision, obj_x")
            # if np.isnan(output[3]):
            #     print("NAN in collision, obj_y")
            # if np.isnan(output[4]):
            #     print("NAN in collision, dist")
        return output
