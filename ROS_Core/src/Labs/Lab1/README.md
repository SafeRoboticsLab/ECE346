...
There are **6 tasks** in this lab, and you will need to show your results to a lab TA on slack (i.e., code screenshots and demo videos) or in-person before **11:59PM February 13, 2024**. This lab is quite long, so **start early** and preferably check in with lab TAs after each task.
